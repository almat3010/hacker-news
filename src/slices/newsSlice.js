...
export const getNews = createAsyncThunk("news/getNews", async (i = 0) => {
	const { request } = useHttp();
	const dataId = await request(
...
export const getItem = createAsyncThunk("news/getItem", ({ ids }) => {
	const { request } = useHttp();
